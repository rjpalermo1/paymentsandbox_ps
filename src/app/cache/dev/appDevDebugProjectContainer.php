...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'mariadb', 'port' => '', 'dbname' => 'prestashop', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), $b, $c, array('enum' => 'string'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('vVI7DfDM7LKMThArbSvGpTHAhGUxURL8cqydXQRsu3n4YgqdgweNVw00');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59c67d3ce3bfb4.08802074')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'vVI7DfDM7LKMThArbSvGpTHAhGUxURL8cqydXQRsu3n4YgqdgweNVw00',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2017-09-23',
            'locale' => 'en-US',
            'cookie_key' => 'ikf7ga1kNhzzopAJ67JoQcWqfoe82KbrtLRLG3cM6Emiuik3S0HzYopM',
            'cookie_iv' => 'EmQ3vZmz',
            'new_cookie_key' => 'def000002adb2254e4fba011bc5e45c2db4a45a13abf6b02da797afec6ed0325dee7e3adfbc58931eba35b0486ff0d0814f18a581911e7caa8e395e3d6f47583a5a04f8e',
            ...
            'kernel.secret' => 'vVI7DfDM7LKMThArbSvGpTHAhGUxURL8cqydXQRsu3n4YgqdgweNVw00',
