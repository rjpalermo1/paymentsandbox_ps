...
class __TwigTemplate_0f1a0536d1ce38decea3f767d5a9c9b18da75e9ecf8cda859aa38b7292e4bf70 extends Twig_Template
{
    ...
    {
        $__internal_718b53f614783f2a6aa5ce173ef1e2e7f09a0ec80f4a26686f79b5521cd02df7 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_718b53f614783f2a6aa5ce173ef1e2e7f09a0ec80f4a26686f79b5521cd02df7->enter($__internal_718b53f614783f2a6aa5ce173ef1e2e7f09a0ec80f4a26686f79b5521cd02df7_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "PrestaShopBundle:Admin/Module/Includes:action_menu.html.twig"));
...
";
        // line 34
        if (((isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")) > twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_READ"))) {
            // line 35
            echo "  ";
  ...
  ";
    ...
    <form class=\"btn-group form-action-button\" method=\"post\" action=\"";
      ...
      <button type=\"submit\" class=\"btn btn-primary-reverse btn-primary-outline light-button module_action_menu_";
          ...
          data-confirm_modal=\"module-modal-confirm-";
                ...
                echo twig_escape_filter($this->env, (isset($context["url_active"]) ? $context["url_active"] : $this->getContext($context, "url_active")), "html", null, true);
                echo "\" ";
                if ((((isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")) < twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_UPDATE")) || (((isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")) < twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_DELETE")) && !twig_in_filter((isset($context["url_active"]) ? $context["url_active"] : $this->getContext($context, "url_active")), array(0 => "configure", 1 => "install", 2 => "upgrade"))))) {
    ...
    ";
                ...
                if ((twig_length_filter($this->env, (isset($context["urls"]) ? $context["urls"] : $this->getContext($context, "urls"))) > 1)) {
                    // line 53
                    echo "      ";
                    if ((((isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")) > twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_CREATE")) || ((twig_in_filter("configure", twig_get_array_keys_filter((isset($context["urls"]) ? $context["urls"] : $this->getContext($context, "urls")))) && twig_in_filter("upgrade", twig_get_array_keys_filter((isset($context["urls"]) ? $context["urls"] : $this->getContext($context, "urls"))))) && twig_in_filter((isset($context["url_active"]) ? $context["url_active"] : $this->getContext($context, "url_active")), array(0 => "configure", 1 => "install", 2 => "upgrade"))))) {
                        // line 54
            ...
            ";
                        ...
                        foreach ($context['_seq'] as $context["module_action"] => $context["module_url"]) {
                            ...
                            if (($context["module_action"] != (isset($context["url_active"]) ? $context["url_active"] : $this->getContext($context, "url_active")))) {
                                // line 61
                                echo "                ";
                                if ((((isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")) >= twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_DELETE")) || (((isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")) < twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_DELETE")) && twig_in_filter($context["module_action"], array(0 => "configure", 1 => "install", 2 => "upgrade"))))) {
                                    // line 62
                                    echo "                  <li>
  ...
  ";
        ...
        $__internal_718b53f614783f2a6aa5ce173ef1e2e7f09a0ec80f4a26686f79b5521cd02df7->leave($__internal_718b53f614783f2a6aa5ce173ef1e2e7f09a0ec80f4a26686f79b5521cd02df7_prof);
